...
(function () {
				...
				var handleMouseClick = function (evt) {
					...
					if(!stillRunning){ 
						...
						pdfDoc.requirePage(pageIndex+1).then(function(){
							...
							return doc.extractPDFNetLayersContext();
	...
	var runCustomScript = function(pdfDoc, layersContextID, windowCoord, pageIndex, documentViewer, Annotations, annotManager)
	{
        ...
        function ProcessElements(
            ...
            var elementNum, element, elementBBox, currTransMtx, pageRotMtx, elementopr, elementPoints;
            ...
            return regeneratorRuntime.wrap(function ProcessElements$(context$3$0) {
                ...
                case 1:
                    ...
                    currTransMtx = element.ctm;
                    context$3$0.next = 7;
                    return page.getDefaultMatrix();
                case 7:
                    pageRotMtx = context$3$0.sent;
                    context$3$0.next = 10;
                    return pageRotMtx.mult(elementBBox.x1, elementBBox.y1);
                case 10:
                    bboxRotatedP1 = context$3$0.sent;
                    context$3$0.next = 13;
                    return pageRotMtx.mult(elementBBox.x2, elementBBox.y2);
                case 13:
                    bboxRotatedP2 = context$3$0.sent;

                    if (!(bboxRotatedP1.x < pdfMousePoint.x && bboxRotatedP2.x > pdfMousePoint.x && bboxRotatedP1.y < pdfMousePoint.y && bboxRotatedP2.y > pdfMousePoint.y)) {
                        context$3$0.next = 18;
                        break;
                    }
                ...
                case 20:
                    ...
                    elementopr = element.operators;
                    elementPoints = element.points;
                    return context$3$0.delegateYield(ProcessPaths(elementopr, elementPoints, currTransMtx, pageIndex), "t1", 24);
                case 24:
        ...
        function ProcessPaths(opr, point, currTransMtx, pageIndex) {
            ...
            return regeneratorRuntime.wrap(function ProcessPaths$(context$3$0) {
                ...
                case 3:
                    ...
                    break;
                case 7:
                    x1 = point[point_index];
                    ++point_index;
                    y1 = point[point_index];
                    ++point_index;
                    context$3$0.next = 13;
                ...
                case 25:
                    ...
                    x2 = point[point_index];++point_index;
                    y2 = point[point_index];++point_index;
        ...
        function ExtractElements(page_reader) {
            var elementArray, element, ctm, elemType, pathinfo, opr, point, elementBBox, retObj, elementXObj, elementNum, elemArray2;
            ...
            return regeneratorRuntime.wrap(function ExtractElements$(context$3$0) {
                ...
                case 25:
                    ...
                    point = new Float64Array(pathinfo.points);
                    context$3$0.next = 30;
                    return element.getBBox();
                case 30:
                    elementBBox = context$3$0.sent;
                    retObj = {name:"path", type:elemType, ctm:ctm, operators:opr, points:point, bbox:elementBBox};

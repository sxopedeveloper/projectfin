...
(function (exports) {
    ...
    exports.runPDFPageTest = function()
    {
        ...
        function main() {
            var ret, input_path, get_file_path, in_doc, page_count, pages_to_split, docStoreArray, i, new_doc, docbuf, page_num, currDoc, currDocPageCount, itr, in1_doc, in2_doc, src_page, dst_page, doc, cover, p7;
            ...
            return regeneratorRuntime.wrap(function main$(context$3$0) {
                ...
                case 20:
                    ...
                    console.log("newsletter_split_page_" + i + ".pdf");
                ...
                case 26:
                    ...
                    saveBufferAsPDFDoc(docbuf, "newDoc.pdf");
                case 28:
                    ++i;
                    context$3$0.next = 17;
                    break;
                ...
                case 65:
                    context$3$0.prev = 65;
                    context$3$0.t1 = context$3$0["catch"](37);
                ...
                case 97:
                    context$3$0.prev = 97;
                    context$3$0.t2 = context$3$0["catch"](69);
                ...
                case 142:
                    ...
                    break;
                case 144:
                    context$3$0.prev = 144;
                    context$3$0.t6 = context$3$0["catch"](101);
                    console.log(context$3$0.t6.stack);
                    ret = 1;
                case 148:
                    context$3$0.prev = 148;
                ...
                case 176:
                    ...
                    context$3$0.t7 = context$3$0["catch"](148);
            ...
            }, marked2$0[0], this, [[4, 33], [37, 65], [69, 97], [101, 144], [148, 176]]);
        }

...
(function(exports) {
    ...
    exports.ControlUtils.initialize = function(notSupportedCallback) {
        ...
        var usePDFNetJS = queryParams.getBoolean('pdfnet', false);
        if (pdfType === 'pnacl' || pdfType === 'ems' || pdfType === 'auto' || pdfType === 'nodejs') {
            var files = ["external/FileSaver.min.js", "pdf/PDFReaderControl.js"];

            if(usePDFNetJS){
                files.push('pdf/PDFNet.js');
            }

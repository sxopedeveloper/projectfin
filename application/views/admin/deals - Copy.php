						...
						<form action="<?php echo site_url('deal/list_view'); ?>" method="get" accept-charset="utf-8" id="main_list_filter_form">
							<div class="panel-body">
										...
										<div class="col-md-12">
											...
											<div>
												<div class="row">				
													<div class="col-md-2">
														<div class="form-group">
															<?php /* ?><label class="control-label"><b>ID or CQ Number:</b></label> <?php */ ?>
													...
													<div class="col-md-2">
														<div class="form-group">
															<?php /* ?> <label class="control-label"><b>Finance:</b></label> <?php */ ?>
															<select class="form-control mb-md" name="finance">
																<option name="finance" value="">Finance</option>
													...
													<div class="col-md-2">
														<div class="form-group">
															<?php /* ?><label class="control-label"><b>Interstate:</b></label> <?php */ ?>
															<select class="form-control mb-md" name="interstate">
																<option name="interstate" value="">Interstate</option>
													...
													<div class="col-md-2">
														<div class="form-group">
															<?php /* ?> <label class="control-label"><b>Tradein:</b></label> <?php */ ?>									
															<select class="form-control mb-md" name="tradein" id="tradein_select">
																<option name="tradein" value="">Tradein</option>
									...
									<div class="col-md-12">
										...
										<div>
											<div class="row">
												...
												<div class="col-md-2">
													<input type="text" class="form-control input-md datepicker filter_date_from filter_date_textbox" name="filter_date_from" placeholder="Date From" value="<?=  $filter_date_from; ?>">
												</div>
												<div class="col-md-2">
													<input type="text" class="form-control input-md datepicker filter_date_to filter_date_textbox" name="filter_date_to" placeholder="Date To" value="<?=  $filter_date_to; ?>">
												</div>
											</div>
										</div>
										<br />
								...
								<footer class="text-right">
									<input value="Apply Filters" name="submit" class="btn btn-primary search-filter-btn" type="submit">
								</footer>
							</div>
						...
						<div class="panel-body">
							<table class="table table-bordered table-striped table-condensed mb-none nowrap" width="100%" cellspacing="0" id="datatable" data-swf-path="<?php echo base_url('assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf'); ?>">
								<thead>
									...
									<?php
									//echo json_encode($session_data); die();
							...
							<a href="<?php// echo site_url("deal/client_automated_invoice_pdf/".$lead->id_fq_account); ?>"  target="_blank">
												...
												<td id="accounts_status_main_td_<?php echo $lead->id_fq_account; ?>"><?php echo $lead->sales_price; ?></td>
												<td><?php echo $lead->dealer_tradein_value; ?></td>
												<td><?php echo $lead->client_status_text; ?></td>
																		
												<td id="lead_admin_status_main_td_<?php echo $lead->id_fq_account; ?>"><?php echo $lead->commissionable_gross; ?></td>
												<td><?php echo number_format($deposits_total, 2); ?></td>										
												<td><?php echo $lead->dealer_status_text; ?></td>
												...
												<td><?php echo $lead->finance; ?></td>
												<td id="settled_date_td_<?php echo $lead->id_fq_account; ?>"><?php echo $lead->settled_date; ?></td>
												<td id="order_date_td_<?php echo $lead->id_fq_account; ?>"><?php echo $lead->commissionable_gross; ?></td>
												<td id=""><?php echo $lead->sales_price; ?></td>
												<td id="settled_date_td_<?php echo $lead->id_fq_account; ?>"><?php echo $lead->quote_specialist; ?></td>
													<td id="quote_specialist_main_td_<?php echo $lead->id_fq_account; ?>"><?php echo $lead->sales_price; ?></td>
												<td id="dealer_td_<?php echo $lead->id_fq_account; ?>"><?php echo $lead->sales_price; ?></td>
												<?php
												$membership = $lead->gross_subtractor;
												...
												$dealer_balance = $lead->dealer_balance;
												?>
												<td class="td-number" id="">-</td>							<td class="td-number" id="total_balcqo_td_<?php echo $lead->id_fq_account; ?>"><?php echo number_format($balcqo, 2); ?></td>

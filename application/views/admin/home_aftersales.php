		...
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<!-- /.Edit Call Back Modal -->					
					<!-- Aftersales Attached Accessories Modal -->
					<div class="modal fade" tabindex="-1" role="dialog" id="aftersales_accessory_modal">
						<div class="modal-dialog" style="width: 80%;">
					...
					<!-- Aftersales Add Accessory Modal -->
					<div class="modal fade" tabindex="-1" role="dialog" id="aftersales_add_accessory_modal_choose">
					...
					<!-- Remarks Modal -->
					<div class="modal fade" tabindex="-1" role="dialog" id="additional_remarks_modal">
					...
					<div class="modal fade" " role="dialog" id="aftersales_add_new_accessory_modal">
						<div class="modal-dialog" style="width: 80%;">
							<div class="modal-content">
								<header class="panel-heading">
					...
					<div class="modal fade" " role="dialog" id="aftersales_add_new_supplier_modal">
						<div class="modal-dialog" style="width: 80%;">
							<div class="modal-content">
								<header class="panel-heading">
									<button type="button" class="close" data-dismiss="modal" aria-label="Close">

	...
	<body>
		...
		<div class="details">
			...
			<table class="content" width="100%">			
				<tbody>
					<tr>
						<th style="border: 1px #000 solid;"><strong>CLIENT ADDRESS</strong></th>
					</tr>				
					<tr>
						<td>
							<?php 
							echo $deal['lead_address'] . " " . $deal['lead_postcode'] . " " . $deal['lead_state'];
							?>
						</td>
					</tr>
				</tbody>
			...
			<table class="content" width="100%">
				<tbody>
					...
					<tr>
						...
						<td><?php echo $deal['lead_name']; ?></td>
						<td><?php echo $deal['lead_phone']; ?></td>
						<td><?php echo $deal['lead_email']; ?></td>
					</tr>
					<tr>

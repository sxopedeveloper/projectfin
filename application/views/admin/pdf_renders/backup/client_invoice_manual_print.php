	...
	<body>
		<table width="100%">
			<tr>
				...
				<td align="right">
					<img src="http://www.mycqo.com.au/assets/img/logos/new_quoteme.png" alt="Quote Me" width="220px;" height="50px;" />
				</td>				
			</tr>
		</table>
						...
						<td width="50%" style="padding: 8px; padding-top: 0px; padding-bottom: 0px;">
							<table class="content" width="100%">
								<tr>
									...
									<td style="border-top: 1px solid #666;" align="right"><p style="font-size: 1.1em;"><?php echo number_format($deal['i_list_price'], 2); ?></p></td>
								</tr>
								<tr>
									<td>Options</td>
									<td align="right"><?php echo number_format($deal['i_options'], 2); ?></td>
								</tr>
								<tr>
									<td>Accessories</td>
									<td align="right"><?php echo number_format($deal['i_accessories'], 2); ?></td>
								</tr>
								<tr>
									<td>Dealer Delivery</td>
									<td align="right"><?php echo number_format($deal['i_dealer_delivery'], 2); ?></td>
								</tr>
								<tr>
									<td><b><p style="font-size: 1.2em;">Price Plus Options & Delivery</p></b></td>
									<td align="right"><p style="font-size: 1.2em;"><?php echo number_format($deal['i_subtotal_1'], 2); ?></p></td>
								</tr>
								<tr>
									<td>Discount</td>
									<td align="right"><?php echo number_format($deal['i_discount'], 2); ?></td>
								</tr>

								<tr>
									<td><b><p style="font-size: 1.2em;">Sub Total</p></b></td>
									<td align="right"><p style="font-size: 1.2em;"><?php echo number_format($deal['i_subtotal_2'], 2); ?></p></td>
								</tr>
								<tr>
									<td>GST Included in Sub Total</td>
									<td align="right"><?php echo number_format($deal['i_gst'], 2); ?></td>
								</tr>
								<tr>
									<td>LCT</td>
									<td align="right"><?php echo number_format($deal['i_lct'], 2); ?></td>
								</tr>

								<tr>
									<td>Stamp Duty</td>
									<td align="right"><?php echo number_format($deal['i_stamp_duty'], 2); ?></td>
								</tr>
								<tr>
									<td>Registration</td>
									<td align="right"><?php echo number_format($deal['i_registration'], 2); ?></td>
								</tr>
								<tr>
									<td>CTP</td>
									<td align="right"><?php echo number_format($deal['i_ctp'], 2); ?></td>
								</tr>
								<tr>
									<td><b><p style="font-size: 1.2em;">Total Price (inc GST)</p></b></td>
									<td align="right"><p style="font-size: 1.2em;"><?php echo number_format($deal['i_total_price'], 2); ?></p></td>
								</tr>
								<tr>
									<td>Deposit</td>
									<td align="right"><?php echo number_format($deal['i_deposit'], 2); ?></td>
								</tr>
								<tr>
									<td>Allowance for Trade In</td>
									<td align="right"><?php echo number_format($deal['i_tradein'], 2); ?></td>
								</tr>
								<tr>
									<td>Payout</td>
									<td align="right"><?php echo number_format($deal['i_payout'], 2); ?></td>
								</tr>
								<tr>
									<td>Refunds</td>
									<td align="right"><?php echo number_format($deal['i_refunds'], 2); ?></td>
								</tr>
								<tr>
									<td>
									...
									<td align="right">
										<b><p style="font-size: 1.3em;">$ <?php echo number_format($deal['i_balance'], 2); ?></p></b>
									</td>
								</tr>								
							</table>
						</td>

                    ...
                    <div class="modal-wrapper">
                        <div class="modal-text">
                            ...
                            <div class="row">
                                <!-- Dealer Selector -->
                                <!--<div class="col-md-12 ">
                                    <div class="col-md-12 popup-detail fa_app_inp  fapplication_summary_new" style=" background: #000;padding: 20px 0;margin-bottom: 30px;">
                                    </div>
                                </div>-->
                                <div class="col-md-12">
                                    <div class="container_bordered_round">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <select class="form-control input-sm" id="make_ds" type="text" <?php /*?>onchange="load_suggested_dealers('start_tender_modal')"<?php */?>>
                                                    <option value=""></option>
                                                    <?php 
                                            ...
                                            <div class="col-md-4">
                                                <select class="form-control input-sm" id="state_ds" type="text" <?php /*?>onchange="load_suggested_dealers('start_tender_modal')"<?php */?>>
                                            ...
                                            <div class="col-md-4">
                                                <?php /*?><input class="form-control input-sm" id="postcode_ds" type="text" value="" placeholder="Postcode" onchange="load_suggested_dealers('start_tender_modal')">
                                                <?php */?><br />
                                            </div>
                                            <div class="col-md-12" id="suggested_dealers" style="background: #f9f9f9;padding:0"></div>
                                            <div class="col-md-12" style="background: #f9f9f9;padding:0">
                                                <br />
                            ...
                            <div class="row" style="margin-top: 20px;">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="container_bordered_round">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control input-sm" id="postcode_ds2" type="text" value="" name="postcode_ds2" placeholder="Postcode">
                                        </div>
                                    </div>
                                    <br />
                                    <div class="container_bordered_round">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control input-sm makeclass" id="make" name="make">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control input-sm modelclass" id="family" name="family" disabled>
                                                <option value="">
                                        ...
                                        <select class="form-control input-sm builddtclass" id="build_date" name="build_date"  disabled>
                                        <option value="">
                                        <span class="loader"></span>
                                        </option>
                                        </select>
                                        ...
                                        <select class="form-control input-sm varientclass" id="vehicle" name="vehicle"  disabled>
                                        <option value="">
                                        <span class="loader"></span>
                                        </option>
                                        </select>
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="">
                                        ...
                                        <select class="form-control input-sm rb_data_option" id="rb_data" name="rb_data">
                                    ...
                                    <div class="container_bordered_round">
                                        ...
                                        <div id="accessory_container">
                                            <input class="form-control input-md" name="accessory_name[]" type="text" placeholder="Accessory" value="N/A"><br />
                                            <textarea style="display:none" class="form-control" name="accessory_desc[]" id="textareaDefault" placeholder="Description">N/A</textarea>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <br />

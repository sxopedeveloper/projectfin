			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<section class="panel">
						...
						<form action="<?php echo site_url('account/fquser'); ?>" id="main_list_filter_form" class="form-horizontal form-bordered" method="get" accept-charset="utf-8">
												...
												<tr id="staff_row_<?php echo $staff->id_user; ?>">
													...
													if ($admin_type == 2)
													{
														...
														<td class="text-center">
															...
															?>													
															<a href="#" id="activate_button_<?php echo $staff->id_user; ?>" onClick="activate_staff(<?php echo $staff->id_user; ?>)" data-toggle="tooltip" data-placement="top" title="Activate FQ User Account " <?php echo $activate_button_hidden; ?>>
																<i class="fa fa-check"></i>
															</a>
															<a href="#" id="deactivate_button_<?php echo $staff->id_user; ?>" onClick="deactivate_staff(<?php echo $staff->id_user; ?>)" data-toggle="tooltip" data-placement="top" title="Deactivate FQ User Account " <?php echo $deactivate_button_hidden; ?>>
														...
														<td class="text-center">
															<a href="#" class="open-editstaff" data-staff_id="<?php echo $staff->id_user; ?>">
																<i class="fa fa-pencil-square-o" data-toggle="tooltip" data-placement="top" title="Edit FQ User Account "></i>
															</a>
														</td>
														<td class="text-center">
															<a href="#" onClick="delete_staff(<?php echo $staff->id_user; ?>)">
																<i class="fa fa-trash-o" data-toggle="tooltip" data-placement="top" title="Delete FQ User Account Permanently"></i>
															</a>
														</td>
														<?php
													}

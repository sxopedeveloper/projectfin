	...
	<body>
				...
				<section role="main" class="content-body">
					...
					<section class="panel">
						<header class="panel-heading">
							...
							<h2 class="panel-title">FinQuote Lead Reallocations</h2>
						</header>
						<div class="panel-body">
							<form action="<?php echo site_url('flead/reallocations'); ?>" method="get" accept-charset="utf-8">
								<div class="row">										
										...
										<tbody>
											...
											foreach ($reallocations as $reallocation)
											{
												...
												<tr>
													...
													<td><?php echo $reallocation->fq_number; ?></td>
													...
													<td><?php echo $reallocation->phone; ?></td>
		...
		<script>
			function get_selected_leads ()
			{
				...
				$.ajax({
					type: 'POST',
					url: "<?php echo site_url('flead/approve_reallocation'); ?>",
					data: dataString,
					cache: false,

		...
		<table width="100%">
			<tr>
				<td align="center">
					...
					<br />
					<br />
					<img src="<?php echo $company_settings['company_logo']; ?>" alt="<?php echo $company_settings['company_name']; ?>" width="320px;" />
					<br />
					<br />
					<br />
					<h1>NEW VEHICLE ORDER</h1>
					<h2><?php echo $deal['po_number']; ?></h2>
					<br />
					<br />
					<br />
				</td>
			...
			<tr>
				<td>
					...
					<p style="font-size: 15px;" align="justify">
						<i>
						The acceptance of this order and subsequent delivery of a motor vehicle also accepts 
						<?php echo $company_settings['company_short_name']; ?>'s Terms and Conditions and any 
						invoice that maybe attached to the transaction. 
						</i>
					</p>
					<br />
					<p style="font-size: 15px;" align="justify">
						<i>
						For more information, you can download <?php echo $company_settings['company_short_name']; ?>'s Dealer 
						Agreement on the Dealer Portal: 
						<a href="http://www.myelquoto.com.au"><font color="#666" style="text-decoration: none">www.myelquoto.com.au</font></a>
						</i>
					</p>
				</td>
			</tr>

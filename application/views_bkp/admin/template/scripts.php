...
<!-- Fixed Columns -->
<script src="<?php echo base_url('assets/vendor/jquery-datatables/extensions/FixedColumns/js/dataTables.fixedColumns.js'); ?>"></script>
...
<!-- Canvas -->
<script src="<?php echo base_url('assets/vendor/html2canvas/html2canvas.js'); ?>"></script>

   ...
   <body>
      <section class="header-section">
         ...
         <section class="main-content">
            <div class="container">
               <div class="row">
                  <div class="btn-green2" style="background: #16c40e; font-weight: bold; color: #fff; text-align: center; margin: 20px 0px 10px; padding: 10px;">New Vehicle Order</div>
                  <div class="table-responsive">
                     <table class="table grey-head-table" style="border:1px solid #969696;">
                        ...
                        <tbody>
                           ...
                           <tr>
                              <td style="padding:1px; width: 50%; border-right:1px solid #969696;">Dealer Contact: <?php echo $lead['dealer_manager_name'];?></td>
                  ...
                  <div class="table-responsive">
                     <table class="table grey-head-table" style="border:1px solid #969696;  font-size:14px;">
                        <thead>
                           <tr>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <td style="padding:1px; width: 50%; border-right:1px solid #969696;">Options: <?php echo implode(",",$rb_data_row['des']); ?>
                              </td>
                              <td style="padding:1px; width: 50%; border-right:1px solid #969696;"></td>
                           </tr>
                           <?php
                  ...
                  <div class="table-responsive">
                     <table class="table grey-head-table" style="border:1px solid #969696;">
                        ...
                        <tbody>
                           <tr>
                              <td style="padding:4px;"><?php echo $computation_data['special_conditions'];?></td>
                           </tr>
                        </tbody>
                        <thead>
                           <tr>

...
{
	$invoice['invoice_name'] = "INVOICE - From ".$company_settings['company_name'];
}
...
if ($invoice['invoice_type']=="Dealer")
{
	$to_details =
	"<b>".$invoice['dealership_name']." (".$invoice['dealer_name'].")</b><br />" .
	$invoice['dealer_email'] . "<br />" .
	$invoice['dealer_address'] . "<br />" . 
	$invoice['dealer_state'] . " " . $invoice['dealer_postcode'] . "<br />" . 
	$invoice['dealer_phone'];
}
else if ($invoice['invoice_type']=="Client")
{
	...
	$to_details =
	"<b>".$invoice['dealership_name']." ".$client_business_name."</b><br />" .
	$invoice['client_email'] . "<br />" .
	$invoice['client_address'] . "<br />" . 
	$invoice['client_state'] . " " . $invoice['client_postcode'] . "<br />" . 
	$invoice['client_phone'];	
}
else if ($invoice['invoice_type']=="Wholesaler")
{
	$to_details = "";
}

$gst = $invoice['amount'] / 11;
?>
<html>
	<head>
	...
	<body>
		...
		<div class="blue_header">
			<strong><?php echo $invoice['invoice_name']; ?></strong>
		</div>
		<div class="details">

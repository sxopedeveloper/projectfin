	...
	<body>
		<table width="100%">
			<tr>
				...
				<td align="right">
					<img src="http://www.carquote.net.au/assets/img/CQ_Logo_v2.png" alt="Car Quotes Online" width="220px;" height="60px;" />
				</td>				
			</tr>
		</table>
						...
						<td width="50%" style="padding: 8px; padding-top: 0px; padding-bottom: 0px;">
							<table class="content" width="100%">
								<tr>
									...
									<td style="border-top: 1px solid #666;" align="right"><p style="font-size: 1.1em;"><?php echo number_format($deal['retail_price'], 2); ?></p></td>
								</tr>
								<tr>
									<td>Options</td>
									<td align="right"><?php echo number_format($deal['options_total'], 2); ?></td>
								</tr>
								<tr>
									<td>Accessories</td>
									<td align="right"><?php echo number_format($deal['accessories_total'], 2); ?></td>
								</tr>
								<tr>
									<td>Dealer Delivery</td>
									<td align="right"><?php echo number_format($deal['edited_dealer_delivery'], 2); ?></td>
								</tr>
								<tr>
								...
								<tr>
									<td>Discount</td>
									<td align="right"><?php echo number_format($deal['edited_dealer_discount'], 2); ?></td>
								</tr>
								<tr>
									<td>Fleet Claim</td>
									<td align="right"><?php echo number_format($deal['edited_fleet_discount'], 2); ?></td>
								</tr>								
								<tr>
								...
								<tr>
									<td>Registration</td>
									<td align="right"><?php echo number_format($deal['edited_registration'], 2); ?></td>
								</tr>
								<tr>
									<td>CTP</td>
									<td align="right"><?php echo number_format($deal['edited_ctp'], 2); ?></td>
								</tr>
								<tr>
								...
								<tr>
									<td>Deposit</td>
									<td align="right"><?php echo number_format($deal['deposits_total'], 2); ?></td>
								</tr>
								<tr>
									<td>Allowance for Trade In</td>
									<td align="right"><?php echo number_format($deal['tradein_given'], 2); ?></td>
								</tr>
								<tr>
									<td>Payout</td>
									<td align="right"><?php echo number_format($deal['tradein_payout'], 2); ?></td>
								</tr>
								<tr>
									<td>Refunds</td>
									<td align="right"><?php echo number_format($deal['refunds_total'], 2); ?></td>
								</tr>
								<tr>
									<td>

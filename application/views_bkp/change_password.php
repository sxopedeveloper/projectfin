				...
				<section role="main" class="content-body">
					...
					<section class="panel">
						...
						<div class="panel-body">
							...
							<?php echo $this->session->flashdata("message"); echo validation_errors("<div style='font-size: 0.8em; margin: 10px; padding: 10px; color: #E85454; border-radius: 3px; border: 1px solid #E45D5D; background-color: #F9D9D9;'>", "</div>"); ?>
						</div>
					</section>
					<!-- end: page -->
				</section>

...
class Datatables
{
	...
	private function _get_datatables_query()
	{
		...
		if(!empty($this->where_not_in)){
			$column_name = $this->where_not_in['column_name'];
			$column_values = $this->where_not_in['column_values'];
			$this->ci->db->where_not_in($column_name, $column_values);
		}
        ...
        if(isset($_POST['search']['value'])){
            if(isset($this->state_search) && !empty($this->state_search)){
                $this->ci->db->like($this->state_search, $_POST['search']['value']);
            }
        }

...
class Admin_main extends CI_Controller
{
	...
	public function __construct()
	{
		...
		if ($this->session->userdata('logged_in'))
		{
			...
			else
			{
				...
				$this->load->model('accessory_supplier_model', '', TRUE);
								...
								<tr>
									<td align="center">
										...
										<p style="font-size: 0.8em; font-family: Verdana, Geneva, sans-serif;">
											...
											Skype: '.$this->settings['company_skype'].' | 
				...
				<table style="padding:10px 0 10px 0px;margin-bottom:5px;border:none">
					<tbody>
						<tr>
							<td style="vertical-align:middle;padding:0 7px 0 0">
								<img height="75" src="[__LOGO__]" class="CToWUd">
							</td>
							<td style="border-left:3px solid #e8e8e8;padding:7px 0 0 10px">
								...
								<div style="margin-bottom: 11px;">
									<a href="mailto:[__EMAIL__]" style="text-decoration:none;color:#134865" rel="nofollow" target="_blank">
										[__EMAIL__]
									</a> | [__PHONE__] | <a>[__MOBILE__]</a>
								</div>
								<div>
									Quote Me  | 
									<a href="[__COMPANY_WEBSITE__]" style="text-decoration:none;color:#134865" rel="nofollow" target="_blank">
										[__COMPANY_WEBSITE__]
									</a>
								</div>
								<div style="margin-bottom: 11px;">
								...
								&nbsp;
								&nbsp;
								<a href="[__COMPANY_FACEBOOK__]" rel="nofollow" target="_blank" style="color: #fff">
									<img src="">
								</a>
								&nbsp;
								<a href="[__COMPANY_GOOGLEPLUS__]" rel="nofollow" target="_blank" style="color: #fff">
									<img src="">
								</a>
								&nbsp;
								<a href="[__COMPANY_LINKEDIN__]" rel="nofollow" target="_blank" style="color: #fff">
									<img src="">
								</a>
							</td>
						</tr>
				...
				$this->email_signature ='<p><span style="font-size:14px;font-family:Calibri,Verdana,Geneva,sans-serif;">Kind Regards,</span></p>
				...
				<div>
					<a href="'.$this->settings['company_url'].'" rilt="Header_Logo" target="_blank" style="text-decoration: none;">
						<img src="'.$this->settings['company_logo'].'" width="300px;" style="margin-right: 15px; margin-top: 15px">
						<br />
					</a>
				</div>
				...
				<div style="text-align: center;" >
					<hr style="clear: both; color: #58C603; background-color: #58C603; height: 2px; border-width: 0;">
					'.$this->settings['company_name'].' | 
					'.$this->settings['company_address_line_1'].' | 
					'.$this->settings['company_address_line_2'].' '.$this->settings['company_suburb'].' | 
					'.$this->settings['company_state'].' '.$this->settings['company_postcode'].' <br />
					Ph: '.$this->settings['company_phone'].' | 
					'.$this->settings['company_email'].' or '.$this->settings['company_alternate_email'].'
				</div>';
				...
				$this->dynamic_fields = array(
					'[_company_name_]', '[_company_abn_]', 
					'[_company_email_]', '[_company_alternate_email_]', '[_company_phone_]', '[_company_mobile_]', '[_company_skype_]', 
					'[_company_state_]', '[_company_postcode_]', '[_company_suburb_]', '[_company_address_line_1_]', '[_company_address_line_2_]',
					
					'[_dealer_name_]', '[_dealer_abn_]',
					'[_dealer_email_]', '[_dealer_phone_]', '[_dealer_mobile_]',
					'[_dealer_state_]', '[_dealer_postcode_]', '[_dealer_suburb_]', '[_dealer_address_]', 
					
					'[_dealer_manager_first_name_]', '[_dealer_manager_name_]', '[_dealer_manager_email_]', 
					'[_dealer_manager_phone_]', '[_dealer_manager_mobile_]',
					
					'[_dealer_account_first_name_]', '[_dealer_account_name_]', '[_dealer_account_email_]', 
					'[_dealer_account_phone_]', '[_dealer_account_mobile_]',
					
					'[_dealer_principal_first_name_]', '[_dealer_principal_name_]', '[_dealer_principal_email_]', 
					'[_dealer_principal_phone_]', '[_dealer_principal_mobile_]',					
					
					'[_client_first_name_]', '[_client_name_]',
					'[_client_email_]', '[_client_phone_]', '[_client_mobile_]',
					'[_client_state_]', '[_client_postcode_]', '[_client_suburb_]', '[_client_address_]', 
					
					'[_lead_cq_number_]', '[_lead_po_number_]', '[_lead_source_]', 
					
					'[_lead_sale_status_]', '[_lead_sale_price_]', 
					
					'[_lead_make_]', '[_lead_model_]', '[_lead_dealer_price_]', '[_lead_changeover_]', 
					
					'[_lead_submitted_date_]', '[_lead_order_date_]', '[_lead_delivery_date_]', '[_lead_settled_date_]', 
					
					'[_qs_first_name_]', '[_qs_name_]',
					'[_qs_email_]', '[_qs_phone_]', '[_qs_mobile_]', 
					'[_qs_state_]', '[_qs_postcode_]', '[_qs_suburb_]',
					
					'[_fqs_name_]', 
					'[_fqs_email_]', '[_fqs_phone_]', '[_fqs_mobile_]', 
					'[_fqs_state_]', '[_fqs_postcode_]', '[_fqs_suburb_]',
					
					'[_tender_make_]', '[_tender_model_]', '[_tender_variant_]', '[_tender_build_date_]', '[_tender_series_]', 
					'[_tender_body_type_]', '[_tender_colour_]', '[_tender_fuel_type_]', '[_tender_registration_type_]'
				);
				
				$left_sidebar_lead_events_html = $this->generate_left_sidebar_lead_events_html();
				//exit;
				$left_sidebar_tenders_html = $this->generate_left_sidebar_tenders_html();
				...
				$this->data = array(
					...
					'left_sidebar_lead_events_html' => $left_sidebar_lead_events_html,
					'left_sidebar_tenders_html' => $left_sidebar_tenders_html,
					...
					<body  width="600px" style="width:800px;    margin: 10px auto;background: #ffffff; font-family: Verdana, Geneva, sans-serif; font-size: 14px; border: 1px solid #d8d8d8; padding: 0px">
						...
						<table style="border-spacing: 0px" bgcolor="#ffffff" width="100%" cellspacing="0" cellpadding="0">
							<tbody>
								...
								<tr>
									<td align="left" style="padding: 15px 30px 15px 30px; color: #484848;">';
				$this->mm_email_footer ='
									</td>
								</tr>
								<tr>
									<td align="left">
										<a href="'.$this->settings['company_url'].'" rilt="Header_Logo" target="_blank" style="text-decoration: none;">
											<img src="'.base_url("/assets/img/logos/email_footer.png").'" style="margin-right: 15px; margin-top: 15px"><br />
										</a>
									</td>
								<td>
								<tr>
	...
	public function generate_left_sidebar_lead_events_html ()
	{
		$user_id = $this->session->userdata('user_id');
		
		$lead_events = $this->lead_model->get_lead_events(array('fk_user' => $user_id, 'status' => 0));
		
		$html = '';
		
		if (count($lead_events)==0)
		{
			$html .= '<center>No records found!</center>';
		}
		else
		{
			...
			{				
				$html .= '
				<p>
					<a href="'.site_url('lead/lead/record_final/'.$lead_event['id_lead']).'">'.$lead_event['cq_number'].'</a>
					<br />
					<b>'.$lead_event['client_name'].'</b>
					<br />
					'.$lead_event['details'].'
					<br />
					<span style="font-size: 0.9em">'.date('F d, Y', strtotime($lead_event['date'])).' '.substr($lead_event['time'], 0, 5).'</span>
				</p>';						
			}							
		}
	...
	public function generate_left_sidebar_tenders_html ()
	{		
		$user_id = $this->session->userdata('user_id');	
	
		$tenders = $this->lead_model->get_all_my_tenders($user_id);
		...
		else
		{
			...
			{
				$new_quote_flag = "";
				if ($tender['new_quotes_count'] > 0)
				{
					if ($tender['new_quotes_count'] == 1)
					{
						$new_quotes_suffix = " New Quote";
					}
					else
					{
						$new_quotes_suffix = " New Quotes";
					}
					
					$new_quote_flag = $tender['new_quotes_count'] . $new_quotes_suffix;
				}
				...
				{
					$quotes_suffix = " Quotes";
				}
				
				$quotes_text = $tender['quotes_count'].$quotes_suffix;
				
				$html .= '
				<p>
					<a href="'.site_url('lead/record_final/'.$tender['id_lead']).'">'.$tender['cq_number'].'</a>
					<span style="color: red; font-size: 0.9em">'.$new_quote_flag.'</span>
					<br />
					<b>'.$tender['name'].'</b>
					<br />
					'.$tender['tender_make'].' '.$tender['tender_model'].'
					<br />
					<span style="font-size: 0.9em">'.$tender['tender_date'].' &nbsp;<b>('.$quotes_text.')</b></span>
				</p>';	
			}							
		}
	...
	public function get_tender_alert_details () // MODAL VIEW // NEW //
	{
		...
		$lead_events = $this->lead_model->get_lead_events(array('fk_lead' => $cheapest_quote['fk_lead'])); // M Array
	...
	protected function mm_send_templated_email ($from_email, $from_name, $to, $subject, $content, $file = "")
	{
		//echo $from_email."-<br>-".$from_name."-<br>-".$to."-<br>-".$subject."-<br>-".$content;
		date_default_timezone_set('Australia/Sydney');
		ini_set('max_execution_time', -1);	
		$now = date("Y-m-d H:i:s");
		$complete_email = $this->mm_email_header.$content.$this->mm_email_footer;
		//$complete_email = $this->mm_email_header."--".$this->mm_email_footer;
	...
	protected function mm_lead_send_templated_email ($from_email, $from_name, $to, $subject, $content, $file = "")
	{
		//echo $from_email."-<br>-".$from_name."-<br>-".$to."-<br>-".$subject."-<br>-".$content;
		date_default_timezone_set('Australia/Sydney');
		ini_set('max_execution_time', -1);	
		$now = date("Y-m-d H:i:s");
		$complete_email = $this->mm_email_header.$content;
		//$complete_email = $this->mm_email_header."--".$this->mm_email_footer;
		//echo $complete_email;exit;
		$this->load->library('email');
		$this->email->clear();
	...
	protected function client_purchase_order_email ($from_email, $from_name, $to, $subject, $content, $file = "",$email_attachment_select)
	{
		...
		if($file[0]!=''){
			$this->email->attach($file[0]);
		}
		if($file[1]!=''){
			$this->email->attach($file[1]);
		}
		
		if(!empty($email_attachment_select)){
			foreach($email_attachment_select as $attachment){
				if($attachment !=''){
					$attachfile = 'uploads/cq_requirements/'. $attachment;
	...
	public function calculate_deal_new ($input_arr, $type = 1)
	{
		...
		$client_invoice_taxes = $input_arr['client_invoice_taxes']; // NEW 
		...
		if ($registration_type == "TPI/Gold Card" OR $client_invoice_taxes == 1)
		{
			$stamp_duty = 0;
			$lct = 0;
		}
		else
		{
			...
			else if ($client_state == "VIC")
			{
				if ($subtotal_3 <= 64132)
				{
					...
					{
						$stamp_duty = $subtotal_3 * 0.032; // 0.042
					} 
	...
	public function calculate_revenue ($input_arr)
	{
		...
		if($input_arr)
		{
			...
			{
				$balcqo = $revenue + $input_arr['other_costs_amount'];
			}

			$output_arr = array(
				'balcqo' => round($balcqo, 2),
    ...
    // Pass an array of data as a result from a query, this automatically output a download file
	public function export_csv ($data = [], $file_name = "")
	{
		$filename = $file_name . "_" . date('Y-m-d') . ".csv";
	...
	// Accepts a post data with file upload
	public function import_csv_1 ()
	{
	...
	// Use this inside a function, just pass the $_FILE you got from post. this returns an array of data to be used for inserting
	public function import_csv_2 ($_FILE = [])
	{
		$file = $_FILES['csv_file'];
		$file_path = $file['tmp_name'];
	...
	public function send_to_many ($from_email, $from_name, $user_type, $subject, $content, $file = "")
	{
		$now = date("Y-m-d H:i:s");
		$complete_email = $this->email_header.$content.$this->email_footer;
